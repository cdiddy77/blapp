 ...
 * pxt-monaco-typescript version: 2.1.6(f7842ab6bf483931e750a07d37348beffaa76515)
...
define('vs/language/typescript/src/languageFeatures',["require", "exports", "../lib/typescriptServices"], function (require, exports, ts) {
    ...
    var SuggestAdapter = (function (_super) {
        ...
        function SuggestAdapter(worker) {
            ...
            _this.exclusionMap = Object.create(null);
            _this.exclusionMap['from'] = 1;
            _this.exclusionMap['import'] = 1;
            _this.exclusionMap['delete'] = 1;
            _this.exclusionMap['with'] = 1;
            _this.exclusionMap['await'] = 1;
            _this.exclusionMap['try'] = 1;
            _this.exclusionMap['catch'] = 1;
            _this.exclusionMap['finally'] = 1;
            _this.exclusionMap['yield'] = 1;
            _this.exclusionMap['as'] = 1;
            _this.exclusionMap['async'] = 1;
            _this.exclusionMap['any'] = 1;
            Object.keys(snippets).forEach(function (snippetKey) {
                var snippet = snippets[snippetKey];
                var prefix = snippet.prefix;
                var body = "";
                snippet.body.forEach(function (element) {
        ...
        SuggestAdapter.prototype.provideCompletionItems = function (model, position, token) {
            ...
            return wireCancellationToken(token, this._worker(resource).then(function (worker) {
                ...
                var suggestions = info.entries
                    .filter(function (entry) { return !_this.exclusionMap[entry.name]; })
                    .map(function (entry) {
                    return {
                        uri: resource,
                        position: position,
