export var Stats = function () {
    ...
    var setMode = function (value: number) {
    ...
    var updateGraph = function (dom: HTMLElement, value: number) {

        let child:HTMLElement = <HTMLElement>dom.appendChild(dom.firstChild);
